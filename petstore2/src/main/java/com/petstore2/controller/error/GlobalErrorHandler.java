package com.petstore2.controller.error;
...
public class GlobalErrorHandler {
    ...
    public ExceptionMessage handleNoSuchElemenException(
    ...
    public ExceptionMessage handleDuplictatekeyException(DuplicateKeyException ex, WebRequest webRequest ) {
   ...
   /* @ExceptionHandler(NoSuchElementException.class)
    public Map<String, String> handleNoSuchElementException(NoSuchElementException exception) {
        ...
        log.error("No element found: {}", exception.getMessage());

      
        Map<String, String> response = new HashMap<>();
        response.put("message", exception.toString());
